...
PlaneJointDemo::PlaneJointDemo(ApplicationControl& ac)
    : mAc(ac)
{

}

std::string PlaneJointDemo::getName()
{
    return "Plane Joint";
}

void PlaneJointDemo::load()
{
    ...
    SGLeafNode* node1 = mAc.getSGControl()->createBox(
                ...
                Vector(0.0,  0.0 + yOffset, 0.0), length, width, length, true);
    ...
    std::shared_ptr<PlaneJoint> planeJoint = std::make_shared<PlaneJoint>(
