...
public:
    ...
    template<class T>
    static std::shared_ptr<MemberAccessor<T>> createDirect(
            T* data,
            Domain* domain = nullptr);

    template<class T, class ObjType>
    static std::shared_ptr<MemberAccessor<T>> createGetter(
    ...
    template<class T>
    static std::shared_ptr<MemberAccessor<T>> createSyncedIfDomain(
