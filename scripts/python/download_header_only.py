...
def download_header_only(target_folder, include_folder, zip_file, download_link, tmp_folder, extern_folder = "extern", verbose = "verbose"):    
    '''
    \param target_folder, e.g. "cgal"
    \param include_folder, e.g. "CGAL-5.0.2/include"
    \param zip_file, e.g. "CGAL-5.0.2-library.zip"
...
def download_headers_only(header_only_descriptions, extern_folder = "extern", verbose = "verbose"):
    '''
    Downloads a header only library as zip file and extracts the relevant include folder in the extern/ folder.
    ...
    for d in header_only_descriptions:
        download_header_only(d.target_folder, d.include_folder, d.zip_file, d.download_link, tmp_folder)
