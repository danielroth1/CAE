...
bash $DIR/download_header_only.sh "cgal" "CGAL-5.0.2" "CGAL-5.0.2-library.zip" "https://github.com/CGAL/cgal/releases/download/releases%2FCGAL-5.0.2/CGAL-5.0.2-library.zip"
