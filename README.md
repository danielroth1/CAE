...
## Documentation
The following paragraphs describe the in CAE implemented approaches a bit more in detail. If a feature is based on a research paper, a reference with a number is added in brackets. The corresponding citations are at the bottom of this document.
